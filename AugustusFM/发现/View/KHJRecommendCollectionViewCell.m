//
//  KHJRecommendCollectionViewCell.m
//  AugustusFM
//
...
@implementation KHJRecommendCollectionViewCell
- (void)dealloc{
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self jxl_setDayMode:^(UIView *view) {
            KHJRecommendCollectionViewCell *cell = (KHJRecommendCollectionViewCell *)view;
...
- (void)layoutSubviews{
    ...
    self.trackTitleLabel.frame = CGRectMake(self.coverMiddleImageView.frame.origin.x, self.coverMiddleImageView.frame.origin.y + self.coverMiddleImageView.frame.size.height + 8 * lFitHeight, self.coverMiddleImageView.frame.size.width, 50 * lFitHeight);
    ...
    self.titleLabel.frame = CGRectMake(self.ircleImageView.frame.origin.x+ self.ircleImageView.frame.size.width + 5 * lFitWidth, self.ircleImageView.frame.origin.y - 3 * lFitHeight, self.trackTitleLabel.frame.size.width - 15 * lFitWidth, 20 * lFitHeight);
    self.titleLabel.alpha = 0.5;
    self.trackTitleLabel.font = [UIFont systemFontOfSize:14 * lFitWidth];
...
- (void)setModel:(KHJDetailRecommend *)model{
    ...
    self.trackTitleLabel.text = model.trackTitle;
